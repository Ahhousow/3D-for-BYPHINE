...
export function Model(props) {
  const { nodes, materials } = useGLTF('https://master--bejewelled-bunny-c31012.netlify.app/models/event-transformed.glb')
  return (
...
useGLTF.preload('https://master--bejewelled-bunny-c31012.netlify.app/models/event-transformed.glb')
